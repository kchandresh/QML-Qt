...
**
** Created by: The Qt Meta Object Compiler version 68 (Qt 6.2.6)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include <memory>
#include "../../17-10-2022/helloworld.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'helloworld.h' doesn't include <QObject>."
#elif Q_MOC_OUTPUT_REVISION != 68
#error "This file was generated using the moc from 6.2.6. It"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_HelloWorld_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject HelloWorld::staticMetaObject = { {
    ...
    qt_meta_stringdata_HelloWorld.offsetsAndSizes,
